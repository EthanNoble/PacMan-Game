...
PACMAN_DEATH_1: str = DIR4 + 'pacman_death_1.png'
PACMAN_DEATH_2: str = DIR4 + 'pacman_death_2.png'
PACMAN_DEATH_3: str = DIR4 + 'pacman_death_3.png'
PACMAN_DEATH_4: str = DIR4 + 'pacman_death_4.png'
PACMAN_DEATH_5: str = DIR4 + 'pacman_death_5.png'
PACMAN_DEATH_6: str = DIR4 + 'pacman_death_6.png'
PACMAN_DEATH_7: str = DIR4 + 'pacman_death_7.png'
PACMAN_DEATH_8: str = DIR4 + 'pacman_death_8.png'
PACMAN_DEATH_9: str = DIR4 + 'pacman_death_9.png'
PACMAN_DEATH_10: str = DIR4 + 'pacman_death_10.png'
PACMAN_DEATH_11: str = DIR4 + 'pacman_death_11.png'
